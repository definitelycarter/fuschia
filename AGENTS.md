...
- `crates/` - Workspace member crates
  ...
  - `fuscia-workflow` - Locked/resolved workflow representation. Validated graph structure with components referenced by digest. Ready for execution. Includes graph traversal utilities.
