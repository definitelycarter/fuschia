//! Integration tests for fuscia-task-host using a real wasm component.

use std::path::Path;

use fuscia_host::{EngineConfig, create_engine};
use fuscia_task_host::{Context, TaskHostState, execute_task, load_component};
