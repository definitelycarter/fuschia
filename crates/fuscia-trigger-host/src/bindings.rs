...
wasmtime::component::bindgen!({
    path: "../../wit",
    world: "fuscia:platform/trigger-component@0.1.0",
    exports: { default: async },
});

/// Implement the host imports for trigger components.
impl fuscia::kv::kv::Host for TriggerHostState {
...
impl fuscia::config::config::Host for TriggerHostState {
  fn get(&mut self, key: String) -> Option<String> {
    self.inner.config_get(&key).cloned()
  }
}

impl fuscia::log::log::Host for TriggerHostState {
